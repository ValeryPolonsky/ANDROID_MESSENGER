 ...
 * {@link design.chat.template.activity.fragment.SlidingTabLayout.TabColorizer}
...
public class SlidingTabLayout extends HorizontalScrollView {
	 ...
	 * {@link #setCustomTabColorizer(design.chat.template.activity.fragment.SlidingTabLayout.TabColorizer)}
	 * .
	 */
	 ...
	 * When using
	 * {@link design.chat.template.activity.fragment.SlidingTabLayout} you are
	 * required to set any
	...
	protected TextView createDefaultTabView(Context context) {
		...
		imageView.setBackgroundResource(R.drawable.ic_ab_drawer);
